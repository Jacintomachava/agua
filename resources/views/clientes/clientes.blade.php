                    ...
                    <tbody>
                        ...
                        @foreach($clientes as $cliente)
                            <tr>
                                ...
                                <td>{{$cliente->casa}}</td>
                                <td>
                                    <a class="btn btn-warning btn-xs activate-btn" href="{{route('leitura.contador',['contratoID'=>$cliente->contador])}}" >
                                        Leitura
                                    </a>
                                     <a class="btn btn-danger btn-xs activate-btn" href="{{route('cliente.geolocalizacao',['contratoID'=>$cliente->contador])}}"  >
                                        Geolocalizacao
                                    </a>
                                </td>
                            </tr>
