      ...
      <div class="col-xl-12">
        <div class="card height-equal title-line">
          <div class="card-header">
            <div class="row">
                <div class="col-7">
                    <h2>Registar a ligacao de Agua</h2>
                    <p class="f-m-light mt-1">
                        Faça o registo da ligacao de agua
                    </p>
                </div> 
                <div class="col-5">
            ...
            <div class="card-body basic-wizard important-validation">
              ...
              <form class="row g-3 needs-validation custom-input" id="msform" enctype="multipart/form-data">
                  ...
                  <form1 class="stepper-one row g-3 needs-validation custom-input" >
                    ...
                    <input class="form-control" type="hidden" name="codigo" value="{{ $cliente->codigo }}">
                    ...
                    <div class="col-4">
                      <label class="form-label" for="passwordwizard">Divida Total<span class="txt-danger">*</span></label>
                      <input class="form-control"  type="text" name="divida" id="divida" value="{{$cliente->divida}}"  >
                    </div>

                    <div class="col-4">
                      <label class="form-label" for="latitude">Taxa de Reestalacao <span class="txt-danger">*</span></label>
                      <input class="form-control" type="text"  name="taxa" id="taxa" >
                    </div>

                    <div class="col-4">
                      <label class="form-label" for="longitude">Total a Pagar <span class="txt-danger">*</span></label>
                      <input class="form-control" type="text"  name="total_a_pagar" id="total" readonly style="background-color: #f5f5f5; color: #555;">
                    </div>
                  ...
                  <div class="wizard-footer d-flex gap-2 justify-content-end">
                      <button id="botao_salvar" type="submit" class="btn btn-success w-100">
                          <span id="botao_texto">{{__('Registar a Ligacao')}} </span>
...
<script>
    ...
    function normalizeNumber(value) {
        ...
        // Mantém apenas números, ponto e vírgula já convertidos
    ...
    function calcularTotal() {
        let divida = normalizeNumber(dividaInput.value);
        let taxa   = normalizeNumber(taxaInput.value);

        let total = divida + taxa;

        // Atualiza o campo total
        totalInput.value = total.toFixed(2);
    }

    // Recalcular sempre que o usuário alterar divida ou taxa
    dividaInput.addEventListener('input', calcularTotal);
    taxaInput.addEventListener('input', calcularTotal);

    // Calcula automaticamente quando a página carrega
    calcularTotal();
</script>
...
$(document).ready(function() {
    ...
    $("#msform").validate({
        ...
        submitHandler: function(form) {
            $.ajax({
                type: "POST",
                url: "{{route('cliente.registarLigacao')}}",
                ...
                beforeSend: function () {
                    ...
                    $('#botao_texto').text('Regsitando Corte...');
                },
                ...
                success: function(response) {
                    ...
                    $('#botao_texto').text('Registar Corte');
