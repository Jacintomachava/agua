      ...
      <div class="col-xl-12">
        <div class="card height-equal title-line">
          <div class="card-header">
            <div class="row">
                <div class="col-7">
                    <h2>Registar o corte de Agua</h2>
                    <p class="f-m-light mt-1">
                        Faça o registo de corte de agua
                    </p>
                </div> 
                <div class="col-5">
              ...
              <form class="row g-3 needs-validation custom-input" id="msform" enctype="multipart/form-data">
                  ...
                  <form1 class="stepper-one row g-3 needs-validation custom-input" >
                    ...
                    <div class="col-4">
                      ...
                      <input class="form-control"  type="text" name="divida" value="{{$valorPendente+$cliente->divida}}" readonly style="background-color: #f5f5f5; color: #555;" >
                    </div>

                    <div class="col-4">
                      <label class="form-label" for="latitude">Data de Corte <span class="txt-danger">*</span></label>
                      <input class="form-control" type="date"  name="data" >
                    </div>

                    <div class="col-12">
                      <label class="form-label" for="longitude">Motivo <span class="txt-danger">*</span></label>
                  ...
                  <div class="wizard-footer d-flex gap-2 justify-content-end">
                      <button id="botao_salvar" type="submit" class="btn btn-success w-100">
                          <span id="botao_texto">{{__('Registar o Corte')}} </span>
...
$(document).ready(function() {
    ...
    $("#msform").validate({
        ...
        submitHandler: function(form) {
            $.ajax({
                type: "POST",
                url: "{{route('cliente.registarCortar')}}",
