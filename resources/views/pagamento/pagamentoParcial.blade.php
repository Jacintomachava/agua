              ...
              <form class="row g-3 needs-validation custom-input" id="msform" enctype="multipart/form-data">
                  ...
                  <form1 class="stepper-one row g-3 needs-validation custom-input" >
                    ...
                    <div class="col-3">
                      ...
                      <input class="form-control"  type="text" name="consumo" value="0.00" readonly style="background-color: #f5f5f5; color: #555;">
                    </div>
                    ...
                    <div class="col-3">
                      ...
                      <input class="form-control"  type="text" name="multa" value="0.00" readonly style="background-color: #f5f5f5; color: #555;">
                    </div>

                    <div class="col-3">
                      <label class="form-label" for="passwordwizard">Valor Total<span class="txt-danger">*</span></label>
                      <input class="form-control"  type="text" name="valor_total" value="{{ number_format(($leitura->furoClienteContrato->divida), 2,',','.') }}" readonly style="background-color: #f5f5f5; color: #555;">
                    </div>
...
$(document).ready(function() {
    ...
    $("#msform").validate({
        ...
        rules: {
            valor_pago: {
                required: true,
                max: {{ $leitura->furoClienteContrato->divida }},
                min: 1
            }
       },
        submitHandler: function(form) {
            $.ajax({
                type: "POST",
                url: "{{route('pagamento.storeParcial')}}",
