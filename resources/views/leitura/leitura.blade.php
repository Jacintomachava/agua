      ...
      <div class="col-xl-12">
        <div class="card height-equal title-line">
          <div class="card-header">
            <div class="row">
                <div class="col-7">
                    <h2>Fazer Leitura de Contador</h2>
                    <p class="f-m-light mt-1">
                        Faça a leitura de Contador
                    </p>
                </div> 
                <div class="col-5">
            ...
            <div class="card-body basic-wizard important-validation">
              ...
              <form class="row g-3 needs-validation custom-input" id="msform" enctype="multipart/form-data">
                  ...
                  <form1 class="stepper-one row g-3 needs-validation custom-input" >
                    ...
                    <div class="col-4">
                      <label class="form-label" for="latitude">Leitura Anterior <span class="txt-danger">*</span></label>
                      <input class="form-control" type="text" name="leitura_anterior" value="{{$ultimaLeitura}}" readonly style="background-color: #f5f5f5; color: #555;">
                    </div>

                    <div class="col-4">
                      <label class="form-label" for="longitude">Valor Leitura Actual <span class="txt-danger">*</span></label>
                      <input class="form-control" type="text" name="leitura_actual" >
                    </div>
                  ...
                  <div class="wizard-footer d-flex gap-2 justify-content-end">
                      <button id="botao_salvar" type="submit" class="btn btn-success w-100">
                          <span id="botao_texto">{{__('Registar Leitura')}} </span>
