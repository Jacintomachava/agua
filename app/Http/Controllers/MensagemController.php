...
class MensagemController extends Controller
{
    ...
    public function storeCompraSaldo(Request $request)
    {
        try {
                ...
                $descricao = " Compra de '.$tipo.' de ".$valor." MT codigo: ";
                    ...
                    if($pagamento->save()){
                        ...
                        if($recibo->save()){
                            ...
                            if($tipo=='SMS'){
                                ...
                                $pacote->saldo = $credito->saldo_sistema;
                            }
                            ...
                            if($pacote->save()){
                                ...
                                if($tipo=='SMS'){
                                  ...
                                  $credito->saldo_sistema = $credito->saldo_sistema + $valor;
                                }
